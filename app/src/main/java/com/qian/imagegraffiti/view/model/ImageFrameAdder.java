...
public class ImageFrameAdder
{
	 ...
	 * 手写涂鸦
	 */
	public void doodleHanwrite(Bitmap bitmap){
		/*ImageMoveView moveView = new ImageMoveView(mImageView);
		mMoveView = moveView;
		mImageView.setMoveView(moveView);*/
		mImageView.setCurBitmap(bitmap);
	}
	...
	public Bitmap combinate(Bitmap src)
	{
		...
		//int[] location = new int[2];
		//canvas.drawBitmap(watermark, watermark.getLeft(), (src.getHeight() - watermark.getHeight()) / 2, null);
